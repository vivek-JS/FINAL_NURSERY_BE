...
async function resetUserPassword() {
  try {
    console.log("===========================================");
    console.log("Reset Password for User: 7218186452");
    console.log("===========================================\n");

    // Connect to MongoDB
    console.log("Connecting to MongoDB...");
    console.log("Using:", MONGODB_URI.includes('mongodb+srv') ? 'Cloud Database (MongoDB Atlas)' : 'Local Database');
    ...
    console.log("✓ SUCCESS!");
    console.log("===========================================");
    console.log(`Password for ${user.name} (${PHONE_NUMBER}) has been reset to: ${NEW_PASSWORD}`);
