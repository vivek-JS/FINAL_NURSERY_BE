...
import purchaseReturnRoute from "./routes/purchaseReturn.route.js";
import moneyLedgerRoute from "./routes/moneyLedger.route.js";
...
server.use("/api/v1/inventory/purchase-returns", authenticateToken, purchaseReturnRoute);
server.use("/api/v1/inventory/money-ledger", authenticateToken, moneyLedgerRoute);
