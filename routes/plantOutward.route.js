...
router.patch('/plant-outward/primary-inward/:batchId/:primaryInwardId', updatePrimaryInward);
router.delete('/plant-outward/:batchId/primary-inward/:primaryInwardId', deletePrimaryInward);
